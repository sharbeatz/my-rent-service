...
export const offers: FullOffer[] = [
  ...
  },
  {
    ...
    description: 'A stylish and modern loft in the heart of Amsterdam, perfect for couples or solo travelers.',
    type: 'apartment',
    price: 200,
    city: {
      name: 'Amsterdam',
    ...
    rating: 4.8,
    bedrooms: 2,
    goods: ['Wi-Fi', 'Kitchen', 'Washer', 'Coffee machine', 'Heating', 'Towels'],
    host: {
      name: 'Lena',
      avatarUrl: '/img/avatar-lena.png',
      isPro: true,
    },
  ...
  },
  {
    ...
    description: 'A beautiful canal-side house offering breathtaking views and a serene atmosphere.',
    type: 'house',
    price: 250,
    city: {
      name: 'Amsterdam',
    ...
    rating: 4.7,
    bedrooms: 3,
    goods: ['Wi-Fi', 'Dishwasher', 'Washing machine', 'Towels', 'Baby seat'],
    host: {
      name: 'Mark',
  ...
  },
  {
    ...
    title: 'Elegant Studio near Rijksmuseum',
    description: 'A cozy and stylish studio, just a short walk from the famous Rijksmuseum.',
    type: 'room',
    price: 120,
    city: {
      name: 'Amsterdam',
    ...
    rating: 4.5,
    bedrooms: 1,
    goods: ['Heating', 'Wi-Fi', 'Breakfast', 'Air conditioning'],
    host: {
      name: 'Emma',
      avatarUrl: '/img/avatar-emma.png',
      isPro: true,
    },
